                               ...
                               struct flb_config *config)
{
    ...
    while (msgpack_unpack_next(&result,
        ...
        /* Pack an empty map of original size + 1 because we are appending one additional keyval pair later */
        ...
        msgpack_pack_str_with_body(&pk, "fluent bit example plugin", 25);
